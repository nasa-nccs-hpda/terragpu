...
def getparser():
    ...
    optionalargs.add_argument("-i", "--image", type=str, default=False, help="VHR Stack to predict")
    return parser
...
def main():
    ...
    if model:
        ...
        #model = 'model_5Images_0002.pkl'
        #model_save = os.path.join(modelDir, model) 
        #apply_model(VHRstack, dir_dict['Classified'], model)
        print (model)  
        apply_model(image, dir_dict['Classified'], model)
